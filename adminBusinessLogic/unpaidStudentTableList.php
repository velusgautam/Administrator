...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#inactiveTableContainer').jtable({
            title: '<i class="icon-user"></i> Unpaid Student Listing',
            paging: true,
            pageSize: 15,
            sorting: true,
            defaultSorting: 'student_name ASC',
            actions: {
                listAction: 'adminBusinessLogic/unpaidStudentListingData.php?action=list&role=<?php echo $_SESSION['Role']; ?>&schlid=<?php echo $_SESSION['SchoolCode'];?>',
                deleteAction: 'adminBusinessLogic/unpaidStudentListingData.php?action=delete'
            },
            fields: {
                student_id: {
                    title: 'Key',
	            ...
	            details: {
		            ...
		            display: function (data) {
			            var $link = $('<a href="#"><button class="btn btn-primary">Details</button></a>');
			            $link.click(function(){
