...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#studentTableContainer').jtable({
            title: '<i class="icon-user-md"></i> Active Student Listing',
            paging: true,
            pageSize: 15,
            sorting: true,
            defaultSorting: ' schl_id, stream_id, class_id, division_id, student_name ASC',
            actions: {
                ...
                deleteAction: 'adminBusinessLogic/studentListingData.php?action=delete'
            },
            toolbar: {
                items: [
                    {
            ...
            fields: {
	            ...
	            details: {
		            ...
		            display: function (data) {
			            var $link = $('<a href="#"><button class="btn-small btn-danger" style="font-size: 12px">Details</button></a>');
			            $link.click(function(){
