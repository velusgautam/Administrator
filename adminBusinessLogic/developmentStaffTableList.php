...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#classTableContainer').jtable({
            title: 'Development Login Listing',
            paging: true,
            pageSize: 10,
            sorting: true,
            defaultSorting: 'sl ASC',
            actions: {
                listAction: 'adminBusinessLogic/developmentStaffListingData.php?action=list',
                createAction: 'adminBusinessLogic/developmentStaffListingData.php?action=create',
                updateAction: 'adminBusinessLogic/developmentStaffListingData.php?action=update',
                deleteAction: 'adminBusinessLogic/developmentStaffListingData.php?action=delete'
            },
