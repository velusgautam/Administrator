...
?>
<div id="inactiveTableContainer" style="width: 100%;"></div>
<?php
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#inactiveTableContainer').jtable({
            title: '<i class="icon-user"></i> Inactive Student Listing',
            paging: true,
            pageSize: 15,
            sorting: true,
            defaultSorting: 'student_name ASC',
            actions: {
                listAction: 'adminBusinessLogic/inactiveStudentListingData.php?action=list&role=<?php echo $_SESSION['Role']; ?>&schlid=<?php echo $_SESSION['SchoolCode'];?>',
                deleteAction: 'adminBusinessLogic/inactiveStudentListingData.php?action=delete'
            },
            toolbar: {
                items: [
                    {
                        tooltip: 'Click Register New Student',
            ...
            fields: {
	            ...
	            details: {
		            ...
		            display: function (data) {
			            var $link = $('<a href="#"><button class="btn-small btn-primary">Details</button></a>');
			            $link.click(function(){
				            window.parent.location.href = "studentDetails.php?id=" + data.record.student_id;
			            });
			            return $link;
		            }
	            },
                fee_payment: {
                    ...
                    sorting:false,
                    display: function (data) {
                        var $link = $('<a href="#"><button >Pay Fees</button></a>');
                        $link.click(function(){
                            window.parent.location.href = "feePayment.php?id=" + data.record.student_id;
                        });
                        return $link;
                    }
                },
                edit: {
                    ...
                    display: function (data) {
                        ...
                        $link.click(function(){
                            window.parent.location.href = "studentUpdate.php?id=" + data.record.student_id;
                        });
                        return $link;
                    }
                }
