...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#inactiveTableContainer').jtable({
            title: '<i class="icon-user"></i> Inside School Promotted Student Listing',
            paging: true,
            pageSize: 15,
            sorting: true,
            defaultSorting: 'student_name ASC',
            actions: {
                listAction: 'adminBusinessLogic/insidePromottedStudentListingData.php?action=list&role=<?php echo $_SESSION['Role']; ?>&schlid=<?php echo $_SESSION['SchoolCode'];?>',
                deleteAction: 'adminBusinessLogic/insidePromottedStudentListingData.php?action=delete'
            },
            fields: {
                student_id: {
                    title: 'Key',
