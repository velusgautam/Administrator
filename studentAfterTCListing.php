...
<div class="container">
	...
	<div class="row-fluid">
		...
		<form id="studentForm" action="adminBusinessLogic/studentTCChangeSave.php" enctype="multipart/form-data" method="post">
			<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="well padding span12">
					...
					<div class="span6">
						...
						<div class="controls">
							<div class="span5">
								<div style="padding-left: 10px; padding-top: 10px; font-size: 18px; font-weight: bold">Select Student Option:</div>
							</div>
							<div class="span3">
								<label class="radio" style="margin-top: 5px;"><span><input class="radioButton" type="radio" name="type" tabindex="5" value="1" checked=""></span>

									<div style="padding-left: 10px; padding-top: 3px; font-weight: bold">Promotion</div>
								</label>
							</div>
							<div class="span4">
								<label class="radio" style="margin-top: 5px;"><span><input class="radioButton" type="radio" name="type" tabindex="6" value="2"></span>

									<div style="padding-left: 10px; padding-top: 3px; font-weight: bold">In Active</div>
								</label>
							</div>
					...
					<div class="span6">
						...
						<button type="button" class=" btn-primary btn-large" tabindex="6" id="save" style="float: right ">Update Student Details</button>
						<div id='loading1'></div>
					</div>
