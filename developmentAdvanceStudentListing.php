    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <form>
                <table style="width: 100%; border-radius: 5px; background-color: #fff; margin-top: 5px; ">
                    ...
                    <tr>
                        ...
                        <td style="padding:0px 5px 0px 5px;">
                            <select class="input-block-level" name="classData" id="classData" tabindex="2">
                                ...
                                if ($_SESSION['Role'] == '1') {
	                                ...
	                                $counter = $db->query_first("SELECT Count(distinct(stream_id)) as count FROM " . TABLE_CLASS_MAPPING . " where schl_id = '".$_SESSION['SchoolCode']."'");
                                }
                                ...
                                while ($classRow = $db->fetch_array($resultClassData)) {
                                    ...
                                    else if(intval($counter['count'])==2)
                                    {
                        ...
                        <td>
                            <select style="width: 150px" name="feesStatus" id="feesStatus">
                                <option value="1">Fees Paid</option>
                                <option value="3">Fees UnPaid</option>
                                <option value="4">Inside Promotted</option>
                            </select>
                        </td>
                        <td>
                            <select style="width: 150px" name="admissionStatus" id="admissionStatus">
                                <option value="1">New Admission</option>
                                <option value="2">Re Admission</option>
                            </select>
                        </td>
            ...
            <div class="well no-padding">
                ...
                <?php include_once('adminBusinessLogic/developmentAdvanceStudentTableList.php'); ?>
