...
<head>
	<?php
		...
		$sql = "SELECT TS.student_id, TS.date, TS.academic_year, TS.admission_id,  TS.stream_id, TS.student_name, TS.schl_id, TS.class_id, TS.division_id,  TS.status, TA.transfer_tc, TA.transfer_mc, TA.transfer_cc,
				...
				TA.taluk,TA.district,TA.place, TA.mothertongue, TA.religion, TA.caste, TA.dob, TA.gender, TA.placeofbirth, TA.nationality, TA.whethersct, TA.father_name, TA.father_qualification,
				TA.father_occupation, TA.mother_name, TA.mother_qualification, TA.mother_occupation,TA.annual_income, TA.noofsis, TA.noofbro, TA.mother_email, TA.father_email, TA.permanent_address, TA.father_phone, TA.mother_phone,
				TA.resi_no
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="well no-padding">
				...
				<div class="control-group" style="min-height: 35px">
					<div class="span2" ><a href="generateTc.php?id=<?php echo $rows['student_id'] ?>">
							<button class="btn-info btn">Generate TC</button>
						</a></div>
					<div class="span3"><a href="generateSchoolCertificate.php?id=<?php echo $rows['student_id'] ?>">
							<button class="btn-inverse btn">Generate Study Certificate</button>
						</a></div>
					<div class="span2"><a href="studentUpdate.php?id=<?php echo $rows['student_id'] ?>">
							<button class="btn-success btn" style=" margin-left: -43px; margin-right: -30px;"> Edit Student Data</button>
						</a></div>
					<div class="span2" style="margin-left:0px; margin-right: 20px"><a href="admissionFormUpdate.php?id=<?php echo $rows['admission_id'] ?>">
							<button class="btn-danger btn"><nobr>Edit Admission Form</nobr></button>
						</a></div>

					<div class="span3" style="margin-left:-10px;"><a href="previousFeeListing.php?id=<?php echo $rows['student_id'] ?>">
							<button class="btn-inverse btn" style="margin-left: 80px;">Previous Fee Receipts</button>
						</a></div>
				...
				<div class="control-group" style="min-height: 30px">
					...
					<div class="btn-group" style="margin-left: 120px;"> <a href="studentListing.php" > <div class=" btn-large btn-success" >Back</div></a>
					</div>
				</div>
