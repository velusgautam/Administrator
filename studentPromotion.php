                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="span 12 padding well">
                            ...
                            <form id="search" method="post" class="form-horizontal" enctype="multipart/form-data" action="adminBusinessLogic/studentSearchList.php">
                                <?php
$width = "18%";
if($_SESSION['Role'] == "1")
{
...
else
{
    ...
    echo"<script type=\"text/javascript\">
                                    ...
                                    setTimeout(\"finishAjax_stream('result_1', '\"+escape(response)+\"')\", 1);
                                        ...
                                        <td id="result_6">
                                            <select name="status" id="status" style="width: 140px">
                                                ...
                                                <option value="3">Fee Unpaid</option>
                    ...
                    <form action="adminBusinessLogic/studentChangeSave.php" enctype="multipart/form-data" method="post"  >
                        <div class="row-fluid">
    ...
    $width = "15%";
                                    ...
                                    <table style="width: 100%" >
                                        <tr>
                                            ...
                                            <td style="width:<?php echo $width; ?>">Class</td>
                                            <td style="width:<?php echo $width; ?>">Division</td>
                                            <td style="width:13%">AcademicYear</td>
                                            <td style="width:14%">Status</td>
                                        </tr>
                                        <tr>
                                            <?php if($admin) {echo '
                            <td>
                                <select name="cschool" id="cschool" style="width: 165px">';
                                                              include('projectinc/schlDDMsg.php');
                                                              echo'</select>
                            <span id="cwait_1" class="help-inline" style="display: none;"><img alt="Please Wait" src="assets/img/ajax-loader.gif"/></span>
                            </td>
                            ';}
else
{
    ...
    echo"<script type=\"text/javascript\">
                                ...
                                $.get(\"projectinc/studentChangeSubDD.php\", {
                                    ...
                                    setTimeout(\"finishAjax_stream('cresult_1', '\"+escape(response)+\"')\", 1);
                                    });
                                    </script>";
}
                                            ?>
                                            <td id="cresult_1">
                                                <select name="cstream" id="cstream" style="width: 140px">

                                                </select>
                                            </td>
                                            <td id="cresult_3">
                                                <select name="cclass" id="cclass" style="width: 140px">

                                                </select>
                                            </td>
                                            <td id="cresult_4">
                                                <select name="cdivision" id="division" style="width: 140px">

                                                </select>
                                            </td>

                                            <td id="cresult_5">
                                                <select name="academicYear" id="academicYear" style="width: 130px">
                                                    <option
                                                            value="2013-2014" <?php echo (((date("n") < 5) && (date("Y") == 2014)) || ((date("n") >= 5) && (date("Y") == 2013))) ? "selected" : ""; ?>>
                                                        2013-2014
                                                    </option>
                                            ...
                                            <td id="cresult_6">
                                                <select name="status" id="status" style="width: 140px">
                                                    ...
                                                    <option value="4" >School Promotion</option>
                                                    <option value="6" >Archive</option>
                                                </select>
                                            </td>
                                            <td >
                                                <input style="padding-left: 15px; padding-right: 15px; padding-top: 5px; padding-bottom: 5px" name="search" id="searchBtn" type="submit" value="Update" class="btn btn-primary btn-large" />
