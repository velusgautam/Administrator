        ...
        <script type="text/javascript">
            $(document).ready(function () {
				...
				$('#ExcelBtn').click('change', function () {
                    $("#search").ajaxForm({
	                    url: 'adminBusinessLogic/excelGeneratorBalanceFeeListing.php',
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="span 12 padding well">
                            ...
                            <form id="search" method="post" class="form-horizontal" enctype="multipart/form-data" action="adminBusinessLogic/feesBalanceSearchList.php">
                                <?php
						$width = "18%";
					if($_SESSION['Role'] == "1")
					{
					    ...
					    $width = "14%";
                                ...
                                <table style="width: 100%" >
                                    <tr>
                                        ...
                                        <td style="width:4%; text-align: center">Search</td>
                                        <td style="width:10%; text-align: center">Excel Export</td>
                                    </tr>
                                    <tr>
                                        <?php if($admin) {echo '
                            <td>
