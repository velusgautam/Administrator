			...
			<form>
				<table style="width: 100%; border-radius: 5px; background-color: #fff; margin-top: 5px; ">
					<tr>
				        ...
				        <td rowspan="2">
					        <button class="btn-success" style="padding: 8px 16px;border-radius: 5px;margin-left: 15px;margin-top: 10px;" type="submit" id="LoadRecordsButton" tabindex="4">Search</button>
				        </td>
						<td rowspan="2" style="width: 150px">
							<button class="btn-primary" style="padding: 8px 16px;border-radius: 5px;margin-left: 15px;margin-top: 10px;"  id="LoadRecordsButton" data-toggle="modal" data-target="#excel-popup" tabindex="5">Excel Export</button>
						</td>
				        <td style="width: 6%">
                ...
                <?php include_once('adminBusinessLogic/studentTableList.php'); ?>
...
<?php
	include_once('includes/excelExport.php');
